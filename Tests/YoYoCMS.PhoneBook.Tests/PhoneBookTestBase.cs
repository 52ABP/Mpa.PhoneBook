...
namespace YoYoCMS.PhoneBook.Tests
{
    public abstract class PhoneBookTestBase : AbpIntegratedTestBase<PhoneBookTestModule>
    {
        ...
        protected Task UsingDbContextAsync(Action<PhoneBookDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<PhoneBookDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<PhoneBookDbContext>())
